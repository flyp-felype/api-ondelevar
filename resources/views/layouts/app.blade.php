...
<head>
  ...
  <title>{{ config('app.name', 'MechAdvisor') }}</title>
  ...
  <script type="text/javascript" src="{{URL::asset('js/tipos.js')}}"></script>
  <script type="text/javascript" src="{{URL::asset('js/oficina.js')}}"></script>
